...
export default function Home({ poolCount, guessCount, userCount }:HomeProps) {
  ...
  return (
    <GoogleOAuthProvider clientId="151621233052-f36spt47302t7mgqk46t738qjkrrmc3p.apps.googleusercontent.com">
     ...
     <form  onSubmit={onSubmitAuthenticationModal} className='mt-10 flex gap-2'>
      <input
    ...
    <div className='mt-10 pt-10 border-t border-gray-600 flex justify-between items-center text-gray-100'>
     ...
     <AuthenticationModal isOpen={isOpen} onCloseModal={() => setIsOpen(false)} pollTitle={poolTitle}/>
    </div>
    </GoogleOAuthProvider>
  )
}
